...
RUN apt-get -y update && apt-get install -y php7.2 php7.2-fpm php7.2-cli php-mbstring php7.2-mbstring php-intl php7.2-intl php7.2-gd php7.2-xml zip unzip php7.2-zip php-curl php7.2-mysql php-mysql php-pear php-dev php-xml php7.2-xml
